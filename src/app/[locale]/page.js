      ...
      <section className="py-20 bg-gradient-to-r from-[#1a365d] to-[#0f1b33] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://wa.me/8615038302121" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-8 py-3 bg-white text-[#1a365d] hover:bg-gray-100 rounded-lg font-semibold transition-colors">
              💬 {t('cta.btn_whatsapp')}
            </a>
          </div>
        </div>
